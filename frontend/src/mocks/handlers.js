...
const mockGameAIWithAgent = {
  "gameId": 5,
  "event": "Partida con IA",
...
const mockGameAIWithoutAgent = {
  "gameId": 6,
  "event": "Partida sin IA",
  "players": ["novice1", "novice2"],
  "agent": null,
  "evaluations": []
};
...
export const handlers = [
    ...
    rest.get('*/api/v1/games/:gameId/ai', (req, res, ctx) => {
        const { gameId } = req.params;
        if (Number(gameId) === mockGameAIWithoutAgent.gameId) {
            return res(
                ctx.status(200),
                ctx.json(mockGameAIWithoutAgent),
            );
        }
        return res(
            ctx.status(200),
            ctx.json(mockGameAIWithAgent),
        );
    }),
...
export { mockMatches, mockGameAIWithAgent, mockGameAIWithoutAgent };
